...
<form:form action="/InternationalizationLocalizationSpringMVC/registerSuccess"
           method="post" commandName="student">
    <h2 align="center"><spring:message code="label.register.header"/></h2>
    <h3 align="center"><a href="/InternationalizationLocalizationSpringMVC?lang=en">English</a> | <a href="/InternationalizationLocalizationSpringMVC?lang=fr">French</a></h3>
    <table align="center">
        <tr>
